...
public class MenuSheetView extends FrameLayout {
     ...
     * @param listener
     *            Listener for menu item clicks in the sheet
     */
     ...
     *            LIST or GRID
     * @param title
     *            Title for the sheet. Can be null
     * @param listener
     *            Listener for menu item clicks in the sheet
     */
    public MenuSheetView(final Context context, final MenuType menuType,
        ...
        inflate(context, menuType == MenuType.GRID ? R.layout.grid_sheet_view
                : R.layout.list_sheet_view, this);
        absListView = (AbsListView) findViewById(
                menuType == MenuType.GRID ? R.id.grid : R.id.list);
        if (listener != null) {
                    ...
                    new AdapterView.OnItemClickListener() {
                        ...
                        public void onItemClick(AdapterView<?> parent,
                            ...
                            listener.onMenuItemClick(
                                    adapter.getItem(position).getMenuItem());
                        }
                    });
        }
    ...
    public void inflateMenu(@MenuRes int menuRes) {
        if (menuRes != -1) {
            SupportMenuInflater inflater = new SupportMenuInflater(
                    getContext());
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        if (menuType == MenuType.GRID) {
            ...
            ((GridView) absListView)
                    .setNumColumns((int) (width / (columnWidthDp * density)));
        }
    ...
    public void setTitle(CharSequence title) {
        if (!TextUtils.isEmpty(title)) {
            ...
            absListView.setPadding(absListView.getPaddingLeft(),
                    originalListPaddingTop + Util.dp2px(getContext(), 8f),
    ...
    /**
     * Override the layout for displaying a list item when of type
     * {@link MenuType#LIST}. <br>
     * Call this before you attach to window using
     * 
     * @param listItemLayoutRes
     *            needs to have an {@link ImageView} with id set to
     *            {@link R.id#icon} and {@link TextView} with id set to
     *            {@link R.id#label}
     */
    ...
    /**
     * Override the layout for displaying a grid item when of type
     * {@link MenuType#GRID}. <br>
     * Call this before you attach to window using
     * 
     * @param gridItemLayoutRes
     *            needs to have an {@link ImageView} with id set to
     *            {@link R.id#icon} and {@link TextView} with id set to
     *            {@link R.id#label}
     */
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            switch (viewType) {
                case VIEW_TYPE_NORMAL:
                    ...
                    if (convertView == null) {
                        convertView = inflater.inflate(menuType == MenuType.GRID
                                ? gridItemLayoutRes : listItemLayoutRes, parent,
                                false);
                ...
                case VIEW_TYPE_SUBHEADER:
                    if (convertView == null) {
                        convertView = inflater.inflate(
                                R.layout.sheet_list_item_subheader, parent,
                                false);
                    }
                ...
                case VIEW_TYPE_SEPARATOR:
                    if (convertView == null) {
                        convertView = inflater.inflate(
                                R.layout.sheet_list_item_separator, parent,
                                false);
                    }
                    break;
            }
    ...
    private static class SheetMenuItem {
        ...
        public boolean isEnabled() {
            ...
            return menuItem != null && !menuItem.hasSubMenu()
                    && menuItem.isEnabled();
        }
